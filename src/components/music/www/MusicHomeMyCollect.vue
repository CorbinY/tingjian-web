...
<script>
  ...
  export default {
    ...
    ,mounted() {
      ...
      this.Axios.post(this.constant.musicHomeMyCollect.api,this.sourceRequest).then(response=>{
      ...
      async prePage() {
        if (this.currentPage >1) {
          ...
          await this.Axios.post(this.constant.musicHomeMyCollect.api, this.sourceRequest).then(response => {
